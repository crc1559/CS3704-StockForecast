...
public class TransactionController implements Serializable {
    ...
    @EJB
    private com.CS3704.sessionbeanpackage.TransactionFacade ejbFacade;
    ...
    public List<Transaction> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Transaction> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class TransactionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Transaction) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Transaction.class.getName()});
                return null;
            }
        }
